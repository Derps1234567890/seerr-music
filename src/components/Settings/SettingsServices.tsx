...
const messages = defineMessages('components.Settings', {
  ...
  lidarrServiceSettingsDescription:
    'Configure your Lidarr server(s) below. You can connect multiple Lidarr servers. Administrators are able to override the server used to process new requests prior to approval.',
