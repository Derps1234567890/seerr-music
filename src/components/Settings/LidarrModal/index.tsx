    ...
    >
      <Formik
        initialValues={{
          ...
          activeMetadataProfileId: (lidarr as LidarrSettings)
            ?.activeMetadataProfileId,
          rootFolder: lidarr?.activeDirectory,
          albumFolder: (lidarr as LidarrSettings)?.albumFolder ?? true,
          tags: lidarr?.tags ?? [],
        ...
        onSubmit={async (values) => {
          try {
            ...
            const submission = {
              ...
              albumFolder: values.albumFolder,
              is4k: false,
              tags: values.tags,
          ...
          return (
            ...
            >
              <div className="mb-6">
                ...
                <div className="form-row">
                  <label htmlFor="albumFolder" className="checkbox-label">
                    {intl.formatMessage(messages.albumFolder)}
                  </label>
                  <div className="form-input-area">
                    <Field
                      type="checkbox"
